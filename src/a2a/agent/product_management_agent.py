...
class AgentFrameworkProductManagementAgent:
    ...
    def _get_agent_response(
        ...
        Args:
            message (str): The JSON message content from the agent.
        ...
        default_response = {
            'is_task_complete': True,  # Assume task is complete for plain text responses
            'require_user_input': False,
            'content': message,  # Use the plain text message directly
        }
